MyApp
    .service('taskService',['$http', '$q',function ($http, $q) {
        ...
        return {
            ...
            getOneStatusPjList: function (pjStatus,pjUser) {
                var deferred = $q.defer();
                // 向后台发送处理数据
                var promise = $http({
                    method: 'POST',
                    url: 'http://localhost:8080/task/getOneStatusTaskList',
                    data: {
                        pjStatus : pjStatus,
                        pjUser : pjUser
                    },
            ...
            removeTaskInfoDataForAudit :function (taskId) {
                var deferred = $q.defer();
                // 向后台发送处理数据
                var promise = $http({
                    method: 'POST',
                    url: 'http://localhost:8080/task/deleteTaskInfoDataForAudit',
                    data: {
                        taskId : taskId
                    },
                    headers: { 'Content-Type': 'application/x-www-form-urlencoded'  ,
